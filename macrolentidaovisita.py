...
pyautogui.press("space")
pyautogui.typewrite("CLIENTE ENTROU EM CONTATO COM LENTIDÃO RECORRENTE, TENTEI FAZER OS PROCEDIMENTOS PADRÃO, TROCAR DNS, LEASE E ATIVAR IPV6, NÃO TIVE SUCESSO. NECESSARIO TEC.")
...
pyautogui.press("space")
time.sleep(0.2)
pyautogui.typewrite("LENTIDÃO RECORRENTE.")
...
pyautogui.typewrite("LENTIDÃO RECORRENTE") # motivo
