...
pyautogui.press("space")
pyautogui.typewrite("CLIENTE ENTROU EM CONTATO DESCONECTADO COM UMA LUZ VERMELHO, PEDI PARA RENICIAR O EQUIPAMENTO E VERIFICAR SE TODOS CABOS ESTÃO BEM CONECTADOS NO EQUIPAMENTO, A LUZ VERMELHA CONTINUOU.")
...
pyautogui.typewrite("LOS") # motivo
